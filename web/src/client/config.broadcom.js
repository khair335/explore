...
class Config {
	constructor() {
		...
		this.sitelink_relaod_document = false;	// https://reactrouter.com/en/main/components/link
		this.autopilot_id = 'f00000000037426';
		this.autopilot_base = 'https://www.broadcom.com';
		this.autopilot_base_domain = 'www.broadcom.com';
		this.swifttype = {
			/*
		...
		//242675 Minor: Language Switcher to Use CDN Domains
		this.domain = UrlParse(window.location.href);
		...
		this.captcha_image = '/img/captcha/submitButton.png';
		...
		if (ENVIRONMENT) {
			switch (ENVIRONMENT) {
				...
				case 'qa':
					...
					//#242675 Minor: Language Switcher to Use CDN Domains
                    if (this.domain.hostname.includes("cdntest")) {
                        this.locale_base = {
                            "en-us": "https://cdntest.aws.broadcom.com",
                            "ja-jp": "https://cdntestjp.aws.broadcom.com",
                            "zh-chs": "https://cdntestcn.aws.broadcom.com",
                            "zh-cn": "https://cdntestcn.aws.broadcom.com",
				...
				case 'stage':
					...
					//#242675 Minor: Language Switcher to Use CDN Domains
					if (this.domain.hostname.includes("cdnstage")) {
                        this.locale_base = {
                            "en-us": "https://cdnstage.aws.broadcom.com",
                            "ja-jp": "https://cdnstagejp.aws.broadcom.com",
                            "zh-chs": "https://cdnstagecn.aws.broadcom.com",
                            "zh-cn": "https://cdnstagecn.aws.broadcom.com",
                            "avg_fr": "https://www.broadcom.fr",
                    };
                    } else {
                        this.locale_base = {
		...
		this.resource_search = {
			endpoint: `https://api.swiftype.com/api/v1/public/engines/search.json?engine_key=${this.swifttype.engine_key}&document_types[]=resources&filters[resources][locale]=${this.locale}${show_china}&facets[resources][]=product_family&facets[resources][]=product&facets[resources][]=category&sort_field[resources]=title&sort_direction[resources]=asc`,
			document_type: 'resources',
			blog_relative_url: 'blog.vmware.com',
		},

		this.video_search = {
			endpoint: `https://api.swiftype.com/api/v1/public/engines/search.json?engine_key=${this.swifttype.engine_key}&document_types[]=videos&filters[videos][locale]=${this.locale}${show_china}&filters[videos][vod_on_demand_publish][]=!False&filters[videos][complete]=true&filters[videos][state]=ACTIVE&filters[videos][account]=broadcom`,
		...
		this.site_link = {
			base_domains: ['broadcom.com', 'www.broadcom.com', 'cmsstaging.broadcom.com', 'satqa.aws.broadcom.com', 'brcm-cs-dev-docs.aws.broadcom.com', 'brcm-cs-qa-docs.aws.broadcom.com', 'brcm-cs-stg-docs.aws.broadcom.com', 'brcm-cs-prd-docs.aws.broadcom.com'],				// This is used to do a check against any site links. If the href matches/contains base_domain, it means its a relative link.
