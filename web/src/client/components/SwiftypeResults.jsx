...
export class SwiftypeResults extends Component {
	...
	buildQuery() {
		...
		//changed sort_field[pages]=sort_date
		// sort_direction[pages]=asc
		// changing sort_field attribute updated_at to sort_date as per ticket #240753
		if (this.state.sortby !== "") {
			query['sort_field[pages]'] = this.props.sort_field || "sort_date";
