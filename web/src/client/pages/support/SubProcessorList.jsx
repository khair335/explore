            ...
            subprocessors = subprocessors.sort((a_subprocessor, b_subprocessor) => {
                ...
                switch (this.state.sortby) {
                    ...
                    case 'product_or_services':
                        a = ((a_subprocessor.product_or_service && a_subprocessor.product_or_service.length > 0)?a_subprocessor.product_or_service[0].part_number:'') || '';
                        b = ((b_subprocessor.product_or_service && b_subprocessor.product_or_service.length > 0)?b_subprocessor.product_or_service[0].part_number:'') || '';
