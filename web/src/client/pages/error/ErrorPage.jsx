...
const error_copy = config.site === 'broadcom' ?
{
	site: 'Broadcom',
	site_map_url: '/sitemap',
	contact_url: '/company/contact-us/feedback-and-comments',

} : {
	site: 'VMWare',
	site_map_url: '/sitemap',
	contact_url: 'https://www.broadcom.com/company/contact-us/feedback-and-comments',
};
	...
	render() {
		return (
			<Container>
				...
				<p className="mb-2">Or we could take you back to the &nbsp;<SiteLink to="/">{error_copy.site} home page</SiteLink>. The <SiteLink to={error_copy.site_map_url}>site map</SiteLink> and site search box, located in the top navigation header of this and every page, can also help you find what you’re looking for.</p>
				<p className="mb-2"><strong>One more thing:</strong> If you want to help us fix this issue, <SiteLink to={error_copy.contact_url}>please contact us</SiteLink> and let us know what went wrong. Be sure to let us know what Web Browser and Operating System you were using when this occurred.</p>
