        ...
        <div className="VideoCard card">
            <div className="card-body">
                ...
                <div className="video-info">
                    ...
                    <SiteLink className='card-video-title' to={url_path} target={target}><h5 dangerouslySetInnerHTML={{ __html: truncateDescription(video_content?.description, 27) }}></h5></SiteLink>
                    <p className='card-video-des' dangerouslySetInnerHTML={{ __html: truncateDescription(video_content?.long_description, 53) }}></p>
                </div>
            </div>
        </div>
    );
