...
export default class MainMenu extends Component {
    constructor(props) {
        ...
        this.updateMenu = this.updateMenu.bind(this);                 //from header.jsx or whatever component called mainmenu
    ...
    render() {
        ...
        return  (
            this.props.navData.map((item, index) => (
                ...
                <NavItem key={item.id} className="mainMenuItem">
...
class MenuItem extends Component {// Products, Solutions, Support landing page links handled differently - true = handle difference
    constructor(props) {
        ...
        this.updateMenu = this.props.updateMenu.bind(this);         // from mainmenu - changes which menu is active
            ...
            <div id="menuWindow" ref={this.menuRef} className="fadein">
                ...
                <div className={(this.state.activeMenu !== false) ? "windowControl menu_open" : "windowControl"}>
                    ...
                    <div className="menuBack">
                        <ButtonTrack onClick={this.handleLevel_1Back}
                            gtmevent={{ "id": "N031", "search_term": this.state.search }}
                            className="back"
                            aria-label="Close main menu"
                        >
                            <span className="bi brcmicon-window-close"></span>
                        </ButtonTrack>
                        <div className="input-group-append input-group-append-clear searchMenu">
                            <input id="searchMenu"
                                type="text"
                                className="bc-input flex-grow-1"
                                placeholder={localizeText("C095","Search the Menu")}
                            ...
                            <ButtonTrack type="button"
                                className="clear-bttn-sm"
                                title="Clear menu search"
                                disabled=""
                                gtmevent={{ "id": "N031", "search_term": this.state.search }}
                                onClick={this.handleClearSearch}>
                                <div className=""><span className={(this.state.showClear) ? "bi brcmicon-times show" : "bi brcmicon-times"}></span></div>
                            </ButtonTrack>
                            <ButtonTrack type="button"
                                title="Search menu"
                                className="search-bttn-sm"
                                gtmevent={{ "id": "N033", "search_term": this.state.search }}
                                disabled=""
